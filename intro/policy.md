...
2. **반드시 이용자 본인이 요청**: SSAPI는 이용을 원하시는 최종 사용자(서버장, 콘텐츠 주최 스트리머, 해당 서비스/콘텐츠의 공식 운영진)가 직접 심사를 요청해야 합니다. API 사용을 원하는 모든 사용자는 반드시 SSAPI에 직접 요청하여 자신만의 고유한 API를 발급받아야 합니다.
   ***위반 사례 예시**:
