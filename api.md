...
<figure><img src=".gitbook/assets/도식.png" alt=""><figcaption><p>서비스 구성도</p></figcaption></figure>
...
그러면 이 API는 왜 사용할까요?\
이API는 다수의 방송인의 데이터를 경우 혹은 여러 개의 플렛폼에서 발생하는 채팅/후원 데이터를 하나의 형태로 제공 받아 개발 공수를 줄이고자 하는 경우에 적합할 수 있습니다.

통상적으로 이러한 작업은 위와 같이 별도의 서버를 구성해야 하고 이를 구성하는 것은 매우 귀찮고 번거로운 일 입니다.
